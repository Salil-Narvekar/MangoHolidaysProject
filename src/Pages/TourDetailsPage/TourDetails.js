...
const TourDetails = () => {
    ...
    const handleSubmitContact = () => {
        ...
        if (!contactFormData.name.trim()) {
        ...
        } else if (!contactFormData.email.trim() || !/^\S+@\S+\.\S+$/.test(contactFormData.email)) {
            setErrorField("email");
            contactEmailRef.current.focus();
            return;

        } else if (!contactFormData.phone.trim() || !/^\d{10}$/.test(contactFormData.phone)) {
            setErrorField("phone");
            ...
            setErrorField(null);
            console.log('Email JS', contactFormData)
    ...
    const handleModalSubmitWhatsapp = () => {
        ...
        } else if (!modalFormDataWhatsapp.phone.trim() || !/^\d{10}$/.test(modalFormDataWhatsapp.phone)) {
            setErrorField("phone");
    ...
    const handleModalSubmitEmail = () => {
        ...
        } else if (!modalFormDataEmail.email.trim() || !/^\S+@\S+\.\S+$/.test(modalFormDataEmail.email)) {
            setErrorField("email");
        ...
        <>
                    ...
                    <div className='tour-quote'>
                        <div className='quote-card'>
                            ...
                            <p className='quote-text'>
                                All Delicious Unlimited Indian Jain / Vegetarian / Non-vegetarian Meals with Variety of Indian, Italian & Continental Meals included
                            </p>
            ...
            <section className="details-section">
                        ...
                        activeTabIndex === 0 ?
                            ...
                            <div className="iternary-details">
                                                ...
                                                tourDetails.ProductItineraryByDay.map((iternary, index) => (
                                                    <div className="card-objects" key={index}>
                                                        ...
                                                        <div className="day-details">
                                                            ...
                                                            {
                                                                (iternary.IsBreakfast === true || iternary.IsDinner === true || iternary.IsLunch === true) &&
                                                                <div className="meals">
                                ...
                                <div className="button-group">
                                    <div className='pop-up-button-itinerary' onClick={() => openModal("whatsapp")}>
                                        <img src="/img/whatsapp.png" alt="Icon" />
                                        <p>Send Itinerary</p>
                                    </div>

                                    <div className='pop-up-button-print' onClick={() => openModal("print")}>
                                        <img src="/img/printer.png" alt="Icon" />
                                        <p>Print Itinerary</p>
                                    </div>

                                    <div className='pop-up-button-email' onClick={() => openModal("email")}>
                                ...
                                <div className="date-price">
                                    {
                                        loading ? (
                                            <div className="loader-container-tour-details">
                                                <ClipLoader color="#ff5f10" loading={loading} size={150} />
                                                <p className="loading-text">Fetching Date & Price Details...</p>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="form-container">
                                            ...
                                            <button className='btn-c' onClick={handleSubmitContact}><p>Submit Enquiry</p></button>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <ul>
                                            {
                                                loading ? (
                                                    ...
                                                    Array.isArray(tourDetails?.highlights) && (tourDetails.highlights).length > 0 ?
                                                        ...
                                                        (
                                                            <div className="data-unavailable-banner">
                                                                <h3>No Highlights are available for this tour Package !!</h3>
                                                            </div>
                                                        )
                                            }
                                        </ul>
                                        ...
                                        <>
                                            {
                                                loading ? (
                                                    <div className="loader-container-tour-details">
                                                        <ClipLoader color="#ff5f10" loading={loading} size={150} />
                                                        <p className="loading-text">Fetching Inclusions & Exclusions...</p>
                                                    </div>
                                                        ...
                                                        <ul>
                                                            {
                                                                Array.isArray(tourDetails?.inclusions) && (tourDetails.inclusions).length > 0 ?
                                                                    ...
                                                                    (
                                                                        <div className="data-unavailable-banner">
                                                                            <h3>No Inclusions are available for this tour Package !!</h3>
                                                                        </div>
                                                                    )
                                                            }
                                                        </ul>
                                                        ...
                                                        <ul>
                                                            {
                                                                Array.isArray(tourDetails?.exclusions) && (tourDetails.exclusions).length > 0 ?
                                                                    ...
                                                                    (
                                                                        <div className="data-unavailable-banner">
                                                                            <h3>No Exclusions are available for this tour Package !!</h3>
                                                                        </div>
                                                                    )
                                                            }
                                                        </ul>
                                                        ...
                                                        <ul>
                                                            {
                                                                Array.isArray(tourDetails?.bookingInstructions) && (tourDetails.bookingInstructions).length > 0 ?
                                                                    ...
                                                                    (
                                                                        <div className="data-unavailable-banner">
                                                                            <h3>No Booking Instructions are available for this tour Package !!</h3>
                                                                        </div>
                                                                    )
                                                            }
                                                        </ul>
                                                        ...
                                                        <ul>
                                                            {
                                                                Array.isArray(tourDetails?.notes) && (tourDetails.notes).length > 0 ?
                                                                    ...
                                                                    (
                                                                        <div className="data-unavailable-banner">
                                                                            <h3>No Notes are available for this tour Package !!</h3>
                                                                        </div>
                                                                    )
                                                            }
                                                        </ul>
                                                        ...
                                                        <ul>
                                                            {
                                                                Array.isArray(tourDetails?.termsConditions) && (tourDetails.termsConditions).length > 0 ?
                                                                    ...
                                                                    (
                                                                        <div className="data-unavailable-banner">
                                                                            <h3>No Terms & Conditions are available for this tour Package !!</h3>
                                                                        </div>
                                                                    )
                                                            }
                                                        </ul>
                ...
                <div>
                    {
                        modalType && (
                            <div className={`modal-overlay ${isModalVisible ? 'active' : 'closing'}`} onClick={closeModal}>
                                {/* Whatsapp Modal */}
                                {
                                    modalType === "whatsapp" && (
                                        <div className="modal-whatsapp" onClick={(e) => e.stopPropagation()}>
                                            ...
                                            <div className="button-container">
                                                <button className="btn-c" onClick={handleModalSubmitWhatsapp}><p>Submit</p></button>
                                            </div>
                                ...
                                {
                                    modalType === "print" && (
                                        <div className="modal-print" onClick={(e) => e.stopPropagation()}>
                                            <div className="modal-image-container">
                                                <img src="/img/itibg.webp" alt="Unavailable" />
                                            </div>
                                            <div className="print-modal-content">
                                                <h2>You’re printing the itinerary & price details for tour</h2>
                                                <p>Please go back to calendar if you wish to change the date or click on Print.</p>
                                                <button className="btn-c" onClick={closeModal}><p>Print</p></button>
                                                <span className="close" onClick={closeModal}>✖</span>
                                            </div>
                                        </div>
                                    )
                                    ...
                                    modalType === "email" && (
                                        <div className="modal-email" onClick={(e) => e.stopPropagation()}>
                                            ...
                                            <div className="email-modal-content">
                                                <h2>You're mailing the itinerary & price details for tour</h2>
                                                <p>Please go back to calendar if you wish to change the date or click on Send Email.</p>
                                                ...
                                                <button className="btn-c" onClick={handleModalSubmitEmail}><p>Send Email</p></button>
                                                <span className="close" onClick={closeModal}>✖</span>
                                            </div>
                                        </div>
                                    )
                                ...
                                {/* Dates-details modal */}
                                {
                                    modalType === "dates-details" && (
                                        <div className="modal-dates-details" onClick={(e) => e.stopPropagation()}>
...

                                                {
                                                    loading ? (
                                                        <div className="loader-container-tour-details">
                                                            ...
                                                            <p className="loading-text">Fetching Pricing Details...</p>
                                                        </div>
                                                                ...
                                                                <div className="table-wrapper">
                                                                    <table>
                                                                        <thead>
                                                                            <tr>
                                                                                <th><p>Currency</p></th>
                                                                                <th><p>Twin Sharing</p></th>
                                                                                <th><p>Triple Sharing</p></th>
                                                                                <th><p>Single Occupancy</p></th>
                                                                                <th><p>Child With Bed</p></th>
                                                                                <th><p>Infant</p></th>
                                                                            </tr>
                                                                        </thead>
                                                                                ...
                                                                                return currencyCodes.map((currency) => (
                                                                                    <tr key={currency}>
                                                                                        ...
                                                                                        {roomTypes.map((type) => {
                                                                                            ...
                                                                                            if (!item) return <td key={type}><p>-</p></td>;
                                                                                ...
                                                                                {["Twin Sharing", "Triple Sharing", "Single Occupancy", "Child With Bed", "Infant"].map((type) => {
                                                                                    ...
                                                                                    return (
                                                                                        <td key={type}>
                                                                                            <p>
                                                                                                {item
                                                                                                    ? Number(item.TotalINRValue || 0).toLocaleString("en-IN")
                                                                                                    : "-"}
                                                                                            </p>
                                                                                        </td>
                                                                                    );
                                                                ...
                                                                <div className="notes">
                                                                    ...
                                                                    {priceDetails && priceDetails.length > 0 && (() => {
                                                                        ...
                                                                        for (let i = 2; i <= 4; i++) {
                                                                            ...
                                                                            const rate = detail[`CurrencyCode${i}SellingRate`];
                                                                            if (code && code.trim() !== "" && rate) {
                                                                                currencies.push(`${code} ${Number(rate).toLocaleString("en-IN")}`);
                                                                            }
                                                                        }

                                                                        return (
                                                                            <p>
                                                                                Tour price variations are expected depending on the prevailing conversion
                                                                                rate. Payment to be calculated on the prevailing rate of exchange of {" "}
                                                                                {currencies} INR on the day of actual payment to Mango Holidays.
                                                                            </p>
                                                                        );
                                                                    })()}
                                                                    ...
                                                                    {priceDetails && priceDetails.length > 0 && (() => {
                                                                        ...
                                                                        return (
                                                                            <p>
                                                                                ...
                                                                                INR{" "}
                                                                                {Number(minPrice).toLocaleString("en-IN")} per adult on{" "}
                                                                                {minDetail?.RoomOccupancyCode || "Twin Sharing"} basis!
                                                                            </p>
                                                                        );
                                                                    })()}

                                                                    <p className="price-note">**Prices increase as seats get filled.**</p>
                                                                </div>
                                                            </>
                                                            :
                                                            <div className="data-unavailable-banner">
